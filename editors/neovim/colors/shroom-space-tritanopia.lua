-- Shroom Space (Tritanopia) for Neovim
-- Generated from VS Code theme. Do not edit manually.
-- Install: copy to ~/.config/nvim/colors/shroom-space-tritanopia.lua or use as plugin
...
function M.setup()
  ...
  vim.g.colors_name = "shroom-space-tritanopia"
