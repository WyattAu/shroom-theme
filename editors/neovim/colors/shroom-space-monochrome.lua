-- Shroom Space (Monochrome) for Neovim
-- Generated from VS Code theme. Do not edit manually.
-- Install: copy to ~/.config/nvim/colors/shroom-space-monochrome.lua or use as plugin
...
M.palette = {
  ...
  selection  = "#444444",
  cursor     = "#FFFFFF",
  line_number = "#88888880",
  line_number_active = "#CCCCCC",
  whitespace = "#444444",
  indent_guide = "#FFFFFF",
  error      = "#FFFFFF",
  warning    = "#AAAAAA",
...
function M.setup()
  ...
  vim.g.colors_name = "shroom-space-monochrome"
