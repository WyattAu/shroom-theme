-- Shroom Space (Deuteranopia) for Neovim
-- Generated from VS Code theme. Do not edit manually.
-- Install: copy to ~/.config/nvim/colors/shroom-space-deuteranopia.lua or use as plugin
...
M.palette = {
  ...
  selection  = "#393552",
  cursor     = "#E0DEF4",
  line_number = "#726D8980",
  line_number_active = "#CCC8D9",
  whitespace = "#726D8950",
  indent_guide = "#BE9AF7",
  error      = "#E68484",
  warning    = "#FFCB6B",
...
function M.setup()
  ...
  vim.g.colors_name = "shroom-space-deuteranopia"
