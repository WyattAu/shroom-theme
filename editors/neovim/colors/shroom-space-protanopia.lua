-- Shroom Space (Protanopia) for Neovim
-- Generated from VS Code theme. Do not edit manually.
-- Install: copy to ~/.config/nvim/colors/shroom-space-protanopia.lua or use as plugin
...
function M.setup()
  ...
  vim.g.colors_name = "shroom-space-protanopia"
